...
function search() {
  try{
    ...
    alert("Please login to search on youtube")
  }
...
try{
  ...
  'raw': readedEncodedMessage
    ...
    function(err){console.error("error",err);status.innerHTML="Sendding Failed, Please check the email adress "});
}
catch(err){
  status.innerHTML="Sendding Failed, Please check the email adress "
}
}
